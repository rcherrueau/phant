...
-- places : Guard (Plain [D,N,A]) (Plain [D,N,A]) (Expr Nil (SCH [A]))
...
-- meetings : Guard (Plain [D,N,A]) (Plain [D,N,A]) (Expr Nil (SCH [D,Count]))
...
-- compose : Guard (Plain [D,N,A]) (Plain [D,N,A]) (Expr Nil (SCH [A,D,Count]))
-- compose = places >>= \q1 =>
--           meetings >>= \q2 =>
